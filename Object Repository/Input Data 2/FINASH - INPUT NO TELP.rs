...
<MobileElementEntity>
   ...
   <name>FINASH - INPUT NO TELP</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and @resource-id = 'inputNoHp' and (@text = '' or . = '')]</locator>
