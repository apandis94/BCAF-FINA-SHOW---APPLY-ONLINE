...
<MobileElementEntity>
   ...
   <name>FINASH - INPUT TANGGAL</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Spinner' and @resource-id = 'inputTglLahir' and (@text = '' or . = '')]</locator>
